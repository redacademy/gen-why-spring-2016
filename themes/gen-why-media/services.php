			...
			<section class="services-hero-container">
				...
				<div id="scroll-target" class="services-sub-banner">
					<div class="services-info">
							<p class="subtitle">Gen Why Media is a female owned and operated creative engagement agency. We specialize in new forms of public participation and cross-generational dialogue.</p>
					</div>
